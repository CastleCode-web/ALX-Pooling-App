...
export function NavigationMenu() {
  ...
  const navigation = [
    ...
    { name: "Create Poll", href: "/dashboard/create-poll", icon: Plus },
                ...
                <>
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <button onClick={handleLogout} className="flex items-center w-full px-3 py-2 text-base font-medium text-red-600 hover:text-red-500 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 rounded-md">
