...
"[project]/lib/hooks/useAuth.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider(param) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const initializeAuth = {
                "AuthProvider.useEffect.initializeAuth": ()=>{
                    try {
                        const storedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFromStorage"])('user');
                        const storedToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFromStorage"])('authToken');
                        if (storedUser && storedToken) {
                            setUser({
                                ...storedUser,
                                accessToken: storedToken,
                                refreshToken: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFromStorage"])('refreshToken') || ''
                            });
                        }
                    } catch (error) {
                        console.error('Auth initialization error:', error);
                        // Clear corrupted auth data
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeFromStorage"])('user');
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeFromStorage"])('authToken');
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeFromStorage"])('refreshToken');
                    } finally{
                        setIsLoading(false);
                    }
                }
    ...
    const login = async (credentials)=>{
        ...
        try {
            ...
            // Store auth data
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setToStorage"])('user', userData);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setToStorage"])('authToken', tokens.accessToken);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setToStorage"])('refreshToken', tokens.refreshToken);
            setUser(authUser);
        } catch (error) {
    ...
    const updateUser = (userData)=>{
        if (user) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setToStorage"])('user', userDataOnly);
        }
    };
...
function withAuth(Component) {
    ...
    _s(AuthenticatedComponent, "yb/FJYAIXt7wZoU4a4YvGQ4Nlsc=", false, function() {
        return [
            useAuth
        ];
    });
    AuthenticatedComponent.displayName = "withAuth(".concat(Component.displayName || Component.name, ")");
...
_s2(usePermissions, "9ep4vdl3mBfipxjmc+tQCDhw6Ik=", false, function() {
    return [
        useAuth
    ];
});
...
//# sourceMappingURL=_dec60ad6._.js.map